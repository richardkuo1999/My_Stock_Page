...
class FakeNewsParser:
    ...
    async def get_buffett_letters(self) -> list[dict[str, str]]:
        return self._get("buffett")

    async def get_howard_marks_memos(self, limit: int = 10) -> list[dict[str, str]]:
        return self._get("howard_marks")
